...
export default function Hero() {
  return (
    <section className="relative min-h-screen overflow-hidden bg-white dark:bg-[#07061a]">
      {/* Glow background */}
      <div className="absolute inset-0">
        <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-225 h-225 bg-purple-500/20 dark:bg-purple-600/20 blur-[160px]" />
        <div className="absolute top-1/3 right-0 w-125 h-125 bg-orange-400/15 dark:bg-orange-500/10 blur-[140px]" />
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 pt-32 text-center">
          ...
          <div className="flex -space-x-2">
            {[...Array(8)].map((_, i) => (
              <Image
                ...
                alt="user"
                className="w-8 h-8 rounded-full border border-white dark:border-[#07061a]"
              />
            ))}
            <span className="w-8 h-8 rounded-full bg-gradient-to-r from-purple-500 to-orange-500 text-white flex items-center justify-center text-xs font-semibold border border-white dark:border-[#07061a]">
              +
            </span>
          </div>
        ...
        {/* Bottom statement */}
        <div
          className="mt-32 animate__animated animate__fadeInUp"
        ...
        >
          ...
          <p className="mt-2 text-3xl md:text-4xl font-semibold bg-gradient-to-r from-purple-500 to-orange-500 bg-clip-text text-transparent">
